...
/*SF_DATA;ver:1.27;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:1,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:2,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,rfrpo:True,rfrpn:Refraction,coma:15,ufog:False,aust:True,igpj:False,qofs:0,qpre:2,rntp:3,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False;n:type:ShaderForge.SFN_Final,id:3138,x:32719,y:32712,varname:node_3138,prsc:2|emission-4032-RGB,clip-4032-A,voffset-8775-OUT;n:type:ShaderForge.SFN_Tex2d,id:4032,x:32102,y:32552,ptovrint:False,ptlb:node_4032,ptin:_node_4032,varname:node_4032,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:e85cb0e1df735a74099480d75a6f13ef,ntxv:0,isnm:False;n:type:ShaderForge.SFN_VertexColor,id:5517,x:31582,y:32586,varname:node_5517,prsc:2;n:type:ShaderForge.SFN_Multiply,id:4157,x:31490,y:33030,varname:node_4157,prsc:2|A-1205-OUT,B-6694-OUT;n:type:ShaderForge.SFN_ValueProperty,id:1205,x:31193,y:32948,ptovrint:False,ptlb:Intensity,ptin:_Intensity,varname:node_1205,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:1;n:type:ShaderForge.SFN_Time,id:978,x:30858,y:33332,varname:node_978,prsc:2;n:type:ShaderForge.SFN_Cos,id:626,x:31059,y:33243,varname:node_626,prsc:2|IN-978-T;n:type:ShaderForge.SFN_TexCoord,id:9234,x:30836,y:33146,varname:node_9234,prsc:2,uv:0;n:type:ShaderForge.SFN_OneMinus,id:1358,x:31059,y:33093,varname:node_1358,prsc:2|IN-9234-V;n:type:ShaderForge.SFN_Multiply,id:6694,x:31273,y:33141,varname:node_6694,prsc:2|A-1358-OUT,B-626-OUT;n:type:ShaderForge.SFN_FragmentPosition,id:4168,x:31071,y:32599,varname:node_4168,prsc:2;n:type:ShaderForge.SFN_Sin,id:1708,x:31266,y:32637,varname:node_1708,prsc:2|IN-4168-X;n:type:ShaderForge.SFN_Multiply,id:8775,x:32196,y:32916,varname:node_8775,prsc:2|A-5517-R,B-8198-OUT;n:type:ShaderForge.SFN_Multiply,id:6923,x:31728,y:32976,varname:node_6923,prsc:2|A-1708-OUT,B-4157-OUT;n:type:ShaderForge.SFN_Append,id:8198,x:31938,y:32934,varname:node_8198,prsc:2|A-6923-OUT,B-4562-OUT,C-6923-OUT;n:type:ShaderForge.SFN_ValueProperty,id:4562,x:31684,y:32807,ptovrint:False,ptlb:Direction,ptin:_Direction,varname:node_4562,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0;proporder:4032-1205-4562;pass:END;sub:END;*/

Shader "Savannah/sav_grass" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_6923 = (sin(mul(unity_ObjectToWorld, v.vertex).r)*(_Intensity*((1.0 - o.uv0.g)*cos(node_978.g))));
